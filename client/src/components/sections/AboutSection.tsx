...
const RESEARCH_INTERESTS = [
  ...
  { label: "Fin-tech", desc: "Applications of Machine Learning in Finance" },  // { label: "NLP in Finance", desc: "Textual analysis of earnings calls and filings" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-4 text-[oklch(0.3_0.02_255)] leading-relaxed text-[0.95rem]">
            <p>
              I am a fourth-year PhD Candidate at the Department of Finance, University of Melbourne.
              I am advised by{" "}
              <a
            ...
            <p>
              My current research applies machine learning methods to empirical asset pricing, with a particular focus on the factor structure of international equity markets. I am also broadly interested in asset management, particularly mutual funds and ETFs.
            </p>
          </div>
        </div>
